...
// 배열.forEach(function(배열안에 있는 각각의 아이템을 찾아오기) {
//   //실행문
// });
...
//사용자에게 숫자를 하나 전달 받으시고 해당 숫자가 소수인지 아닌지 식별해서 소수라면, 웹 브라우저 화면에 "00숫자는 소수입니다."
...
// const arr = [1,3,4,5,7,9,11,13,15,17,19];
...
// 사용자에게 1보다 큰 수를 하나 전달받으세요! 그리고 그 숫자 안에 있는 짝수들만 모두 더해서 웹 브라우저 화면에 출력해주세요

const number = Number(prompt("1보다 큰 수를 하나 작성해주세요"));
let sum = 0;
