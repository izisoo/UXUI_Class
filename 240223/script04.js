...
//this객체
// 단, 조건!!!=> 현재 선택한 li 태그를 this 객체로 대체해서 사용할 수 있음, 단, 클래스 함수를 사용할때에만 가능!! => 화살표 함수를 사용할 때에는 this 객체가 이벤트를 실행시킨느 당사자 = 주체가 되는 것이 아니라 window 객체가 this 가 됩니다.
// const items = document.querySelectorAll("li");
// for (let item of items) {
//   item.addEventListener("click", () => {
//     item.parentNode.removeChild("click", function () {
